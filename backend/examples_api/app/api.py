...
from common.static import createStaticDirectory, staticFolderPath, generatedDataFolderPath
...
createStaticDirectory(staticFolderPath)
createStaticDirectory(generatedDataFolderPath)
